import {
  ...
  Alert,
  Snackbar,
} from "@mui/material"; // Material from MUI
import CloseIcon from "@mui/icons-material/Close"; // imported closeIcon from MUI materials
import axios from "../utils/axios"; // axios file from utils
import { useState } from "react"; // useState function from react
import validator from "validator"; // validator package to validate the input emailID

//This is the function behind the edit button on the page
